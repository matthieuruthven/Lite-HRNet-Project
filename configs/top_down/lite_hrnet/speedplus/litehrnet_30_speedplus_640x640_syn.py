...
val_pipeline = [
    ...
    dict(
        type='Collect',
        keys=['img'],
        meta_keys=['image_file', 'flip_pairs', 'center', 'scale']),
]
...
data = dict(
    ...
    workers_per_gpu=4,
    train=dict(
        type='TopDownSpeedPlusDataset',
        ann_file=f'{data_root}/synthetic/train.json',
        img_prefix=f'{data_root}/synthetic/images/',
        data_cfg=data_cfg,
        pipeline=train_pipeline),
    val=dict(
        type='TopDownSpeedPlusDataset',
        ann_file=f'{data_root}/synthetic/validation.json',
        img_prefix=f'{data_root}/synthetic/images/',
        data_cfg=data_cfg,
