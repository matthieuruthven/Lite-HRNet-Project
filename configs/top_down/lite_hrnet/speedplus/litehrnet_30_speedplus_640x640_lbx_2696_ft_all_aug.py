log_level = 'INFO'
load_from = 'work_dirs/litehrnet_30_speedplus_640x640_syn_new/best_PCKh_epoch_56.pth'
resume_from = None
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=f'{data_root}/lightbox/train_sda_2696.json',
